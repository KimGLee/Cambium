...
| `1.5` | 新增 [[Knowledge Base Standards/10 Writing and Formatting/05 Chinese-first Technical Language\|Chinese-first Technical Language]] 与 [[profiles/agent-atlas/language-contract#Display Language Contract（显示语言契约）\|Naming Context and Linking]] 的 Display Language Contract 节 |
...
- [[Knowledge Base Standards/Read Sets/09 Standards Governance Read Set|Standards Governance Read Set]]
