...
本表为控制面速览；完整词表以各 owner 为准：task_state 见 [[Knowledge Base Standards/02 Build Execution/01 Contract Time and Task State|02/01]]，其余各轴见 [[Knowledge Base Standards/08 Metadata and Status/03 Status Axes|08/03]]。
