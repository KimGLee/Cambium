#!/usr/bin/env python3
"""Stable MCP Host entry; implementation lives at :mod:`Tools.platform.agent_interface.mcp_server`."""
...
def _external_pycache_prefix():
    """Choose an unverified-component-external cache before any import."""
...
IMPLEMENTATION_MODULE = "Tools.platform.agent_interface.mcp_server"

if __name__ == "__main__":
    runpy.run_module(IMPLEMENTATION_MODULE, run_name="__main__", alter_sys=True)
