...
def fence_scan(text):
    ...
    ``repository_structure.check_repository_structure``: up to three leading
    spaces, a matching marker character, a closing run at least as long as the
    opener, and no non-whitespace closing tail.
    """
    blocks = []
    current = None
