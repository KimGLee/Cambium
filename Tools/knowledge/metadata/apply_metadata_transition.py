...
PRODUCER_IDENTITY = \
    metadata_gate_runtime.METADATA_TRANSITION_PRODUCER_IDENTITY
...
def prepare_transition(context, gate_receipt_id, requested_value,
    ...
    gate_receipt = metadata_gate_runtime.current_gate_receipt(
        ...
        current_receipt_catalog=queue_runtime.current_receipt_catalog(
            context.runtime))
    ...
    receipt = kblib.make_receipt(
        ...
        receipt_type_id=
            metadata_gate_runtime.METADATA_TRANSITION_RECEIPT_TYPE_ID,
        root=context.root)
...
def _current_receipt_from(runtime, context, receipt_id, value, *,
    ...
    return metadata_gate_runtime.current_gate_receipt(
        ...
        current_receipt_catalog=queue_runtime.current_receipt_catalog(runtime),
...
def main(argv=None):
    ...
    coverage_snapshot = kblib.repository_target_snapshot(
        root, queue_runtime.COVERAGE_PATH, suffixes=".yaml",
        singly_linked=True)
