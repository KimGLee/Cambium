#!/usr/bin/env python3
"""Stable adoption command and repository-external bytecode boundary."""
...
def _external_pycache_prefix():
    """Choose a cache prefix outside the component tree before any import."""
...
from Tools.governance.standards.adopt_standards import main as _main

IMPLEMENTATION_MODULE = "Tools.governance.standards.adopt_standards"
