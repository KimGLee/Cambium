...
LIST_ACTIONS = ("append", "append_const", "extend")
COUNT_ACTIONS = ("count",)
...
FIELD_SOURCES = {
    ...
    "artifact":
        "Tools/render_interface_projection.py: ARTIFACT_KIND",
    "form":
...
def main(argv=None):
    ...
    try:
        recheck = contract_bytes_hash(contract_path)
    except OSError as exc:
    ...
    if recheck != contract_hash:
        return fail(
            ...
            % (relativize(root, contract_path), contract_hash, recheck))
