...
`check_residual_content`, `stamp_cards`,
...
- `standards_adoption_plan.template.yaml` -- the closed restricted-YAML
  ...
  versus deferred gate split. Its empty after-load lists are placeholders; a
  real plan supplies the complete derived Read Set/module closure
