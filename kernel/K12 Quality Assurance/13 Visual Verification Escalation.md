...
- Previous: [[kernel/K12 Quality Assurance/12 Substantive Correctness Review|Substantive Correctness Review]].
- Next: [[kernel/K12 Quality Assurance/14 Batch Review|Batch Review]].

## Visual Verification Escalation

This module owns the conditions under which visual evidence may be gathered at all. What counts as visual recognition, and the deterministic levels that MUST be run first, are defined in [[kernel/K12 Quality Assurance/02 Rendering Verification#Rendering Verification Levels|Rendering Verification Levels]]; every level below is recorded through [[kernel/K12 Quality Assurance/02 Rendering Verification#Escalation Record|Escalation Record]].
