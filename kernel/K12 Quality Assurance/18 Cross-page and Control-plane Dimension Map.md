...
| `K12/03 Module` | Overview reflects real structure; duplicate canonical notes; orphans; Standards MOC and leaf ownership consistency | emits | structure_and_links |
...
| `K12/09` Closed List | 1 link integrity; 2 structural validity; 3 graph projection and basename candidates | emits | structure_and_links |
