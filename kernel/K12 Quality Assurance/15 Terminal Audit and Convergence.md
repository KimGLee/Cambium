...
4. Reconcile the Coverage Ledger against the file system, exclusions, competency matrix, and Required Queue, including exact Queue-manifest/Coverage-projection equality.
