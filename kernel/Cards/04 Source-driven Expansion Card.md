...
source_files:
  - kernel/Read Sets/04 Source-driven Expansion Read Set.md
  - kernel/06 Knowledge Intake and Evolution/01 Intake Scope and Knowledge Model.md
  - kernel/06 Knowledge Intake and Evolution/03 Source-to-Knowledge Pipeline.md
  - kernel/06 Knowledge Intake and Evolution/04 Intake Note Types and Source Roles.md
  - kernel/06 Knowledge Intake and Evolution/05 Evidence Maturity and Batch Policy.md
  - kernel/06 Knowledge Intake and Evolution/06 Intake Anti-patterns and Acceptance.md
  - kernel/06 Knowledge Intake and Evolution/07 Environmental Scanning and Watermark.md
  - kernel/06 Knowledge Intake and Evolution/08 Canonical Promotion Gate.md
  - kernel/07 Sources and Accuracy/01 Source Hierarchy and Evidence Roles.md
  - kernel/07 Sources and Accuracy/02 Claims Sources and Classification.md
  - kernel/07 Sources and Accuracy/03 Official and Cross-source Verification.md
  - kernel/07 Sources and Accuracy/06 Source Maintenance and Acceptance.md
  - kernel/08 Metadata and Status/04 Evidence and Relationship Metadata.md
  - kernel/03 Note Types and Ownership/02 Ownership and Canonical Notes.md
  - kernel/12 Quality Assurance/04 Guidance and Source Review.md
source_hash: e20df3c8c5e1
---
# Source-driven Expansion Card
...
Turn documentation, papers, code, benchmarks, cases, postmortems, community signals, or user source leads into traceable corpus updates. Load [[kernel/Cards/01 Core Bootstrap Card|Core Bootstrap]], the selected profile's `Source Policy` and `Language Contract`, and `kernel-02` whenever a canonical note is created or changed.
...
Read RS 04 and the relevant owner for user hypotheses, source authority, cross-source independence, benchmark provenance, formula or time sensitivity, source conflict, terminology extraction, or any uncertain promotion decision.
