...
source_files:
  - kernel/Read Sets/02 Single Note Authoring Read Set.md
  ...
  - kernel/04 Content Depth/01 Depth Model and Foundation.md
  - kernel/04 Content Depth/02 Core Concept Structure.md
  - kernel/04 Content Depth/03 Process and Flow Structure.md
  - kernel/04 Content Depth/04 System and Production Reasoning.md
  - kernel/04 Content Depth/05 Source and Evaluation Depth.md
  - kernel/08 Metadata and Status/01 Frontmatter and Core Vocabularies.md
  - kernel/08 Metadata and Status/02 Scope Level Depth and Priority.md
  - kernel/08 Metadata and Status/03 Status Axes.md
  - kernel/09 Wiki Link and Navigation/01 Link Semantics and Body Links.md
  - kernel/10 Writing and Formatting/01 Naming Language and Prose.md
  - kernel/12 Quality Assurance/01 Quality Dimensions and Single Note Review.md
  - kernel/12 Quality Assurance/05 Automated and Manual Checks.md
source_hash: 779c2140ce27
---
# Single Note Authoring Card
...
Create, rewrite, or target one canonical note. Load [[kernel/Cards/01 Core Bootstrap Card|Core Bootstrap]] and the selected profile's `Language Contract`. Combine another Card when source intake, module construction, migration, or long-running execution is involved.
...
- If a reusable proper noun, metric, formula, table, code block, diagram, external claim, or substantive mechanism change appears, follow the matching Triggered route in RS 02.
...
- L-tier: read 12/01 in full and dispatch [[kernel/12 Quality Assurance/12 Substantive Correctness Review|Substantive Correctness Review]] to an independent execution context.
...
Read RS 02 and the named leaf owner for complete note-type depth, terminology extraction, source authority, metric provenance, mathematics, diagrams, visual escalation, or downstream propagation.
