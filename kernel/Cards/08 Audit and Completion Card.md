...
source_files:
  - kernel/Read Sets/08 Audit and Completion Read Set.md
  ...
  - kernel/12 Quality Assurance/08 Judgment Item Dimension Map.md
  - kernel/12 Quality Assurance/09 Batch-close Closed List.md
  - kernel/12 Quality Assurance/06 Completion Gate and Reporting.md
  - kernel/12 Quality Assurance/15 Terminal Audit and Convergence.md
  - kernel/02 Build Execution/07 Completion and Handoff.md
source_hash: 9a97e86c1108
---
# Audit and Completion Card

> Compiled kernel guidance. Do not hand-edit. A Card cannot turn structural success into a completion verdict.

## Use When

Review a note, close a batch or module, or audit a completion candidate. Load [[kernel/Cards/01 Core Bootstrap Card|Core Bootstrap]] and the Cards/Read Sets relevant to the findings.
...
- [ ] Final Handoff and machine-readable Terminal Proof are complete and `check_proof.py` passes.
- [ ] Time contract is satisfied without using time, file count, or check count as proof of completion.

## Read Back When

Read RS 08 and the canonical owner for L-tier review, receipt reuse or invalidation, judgment dimensions, rendering levels, specialized audits, Terminal Proof semantics, or finding convergence. A migration finding additionally reads RS 06.
