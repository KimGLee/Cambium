...
source_files:
  - kernel/Read Sets/09 Standards Governance Read Set.md
  - kernel/00 Standards Control/01 Operating Role and Reading Protocol.md
  - kernel/00 Standards Control/03 Standards Governance.md
  - kernel/00 Standards Control/11 Standards Map and Rule Registry.md
  - kernel/00 Standards Control/12 Control Registry.md
...
source_hash: 1c0f0377ef9b
---
# Standards Governance Card

> Navigation only. A governance decision MUST read RS 09 and every Start module it lists in full. This Card is never sufficient evidence for revising the Standards.
...
- [ ] Load [[kernel/Cards/01 Core Bootstrap Card|Core Bootstrap]], then read [[kernel/Read Sets/09 Standards Governance Read Set|RS 09]] and its Start list in full.
...
- Keep the Overview, domain MOCs, Read Sets, rule registry, control registry, links, and module paths synchronized.
