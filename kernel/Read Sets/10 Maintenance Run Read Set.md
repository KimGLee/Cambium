...
- [[kernel/00 Standards Control/02 Task Routing and Pre-execution|Task Routing and Pre-execution]] (Maintenance Run Envelope and Effort Tiering)
...
- This run produces L-tier pages: read [[kernel/12 Quality Assurance/01 Quality Dimensions and Single Note Review#Substantive Correctness Review|Substantive Correctness Review]].
...
- Batch close: [[kernel/12 Quality Assurance/03 Module Coverage and Batch Review|Module Coverage and Batch Review]].
