...
- [[kernel/00 Standards Control/02 Task Routing and Pre-execution|Task Routing and Pre-execution]]（Maintenance Run Envelope 与 Effort Tiering）
...
- 本轮清单关闭：[[kernel/00 Standards Control/06 Completion Precedence and Task Contract#Maintenance Completion|Maintenance Completion]]——有界完成语义：封套内候选清单关闭＋Ledger 与水位线推进＋各批次过适用 QA gates 即完成；不适用全库 Terminal Proof，被截掉的 deferred 项移交下一轮维护，不构成缺口。
