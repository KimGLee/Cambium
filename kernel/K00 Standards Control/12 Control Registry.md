...
| `runtime-startup-recovery` | `check_queue` | `1.9.0` | `required_queue` | `resume-status` | `*` | `not-batch-scoped` |
...
| `required-queue-consistency` | `check_queue` | `1.9.0` | `required_queue` | `consistency` | `*` | `not-batch-scoped` |
| `required-queue-admission` | `check_queue` | `1.9.0` | `required_queue` | `require-ready:*` | `*` | `queued` |
| `required-queue-completion` | `check_queue` | `1.9.0` | `required_queue` | `require-complete` | `*` | `queue-exhausted` |
| `maintenance-completion` | `check_queue` | `1.9.0` | `required_queue` | `require-maintenance-complete` | `*` | `queue-exhausted` |
...
| `page-contract` | `check_page_contract` | `1.0.0` | `page-contract-summary` | `*` | `*` | `not-batch-scoped` |
...
| `standards-revalidation` | `check_queue` | `1.9.0` | `required_queue` | `require-revalidation:*` | `*` | `queued`, `open` |
