...
| `runtime-startup-recovery` | `check_queue` | `1.12.0` | `required_queue` | `resume-status` | `*` | `not-batch-scoped` |
...
| `required-queue-completion` | `check_queue` | `1.12.0` | `required_queue` | `require-complete` | `*` | `queue-exhausted` |
| `maintenance-completion` | `check_queue` | `1.12.0` | `required_queue` | `require-maintenance-complete` | `*` | `queue-exhausted` |
...
| `standards-revalidation` | `check_queue` | `1.12.0` | `required_queue` | `require-revalidation:*` | `*` | `queued`, `open` |
