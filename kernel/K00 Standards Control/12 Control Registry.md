...
| `runtime-startup-recovery` | `check_queue` | `1.20.0` | `required_queue` | `resume-status` | `*` | `not-batch-scoped` |
...
| `required-queue-consistency` | `check_queue` | `1.20.0` | `required_queue` | `consistency` | `*` | `not-batch-scoped` |
| `required-queue-admission` | `check_queue` | `1.20.0` | `required_queue` | `require-ready:*` | `*` | `queued` |
| `required-queue-completion` | `check_queue` | `1.20.0` | `required_queue` | `require-complete` | `*` | `queue-exhausted` |
| `maintenance-completion` | `check_queue` | `1.20.0` | `required_queue` | `require-maintenance-complete` | `*` | `queue-exhausted` |
...
| `standards-revalidation` | `check_queue` | `1.20.0` | `required_queue` | `require-revalidation:*` | `*` | `queued`, `open` |
