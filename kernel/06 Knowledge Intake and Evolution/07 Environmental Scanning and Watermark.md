...
- Previous: [[kernel/06 Knowledge Intake and Evolution/06 Intake Anti-patterns and Acceptance|Intake Anti-patterns and Acceptance]].
- Next: [[kernel/06 Knowledge Intake and Evolution/08 Canonical Promotion Gate|Canonical Promotion Gate]].

## Environmental Scanning

This is Stage 1 of the [[kernel/06 Knowledge Intake and Evolution/03 Source-to-Knowledge Pipeline#Source-to-Knowledge Pipeline|Source-to-Knowledge Pipeline]]; a maintenance run enters it on its own, without running the stages that follow.
