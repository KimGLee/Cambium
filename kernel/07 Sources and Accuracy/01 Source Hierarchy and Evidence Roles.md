...
The source hierarchy answers only "how reliable a source usually is"; it cannot answer "what this source proves in the current argument". Specific source-to-knowledge admission follows the [[kernel/06 Knowledge Intake and Evolution Standard|Knowledge Intake and Evolution Standard]].
...
Community content usually has a low authority level, but can be a high-value discovery signal or failure evidence; an official company article can prove its public system, yet cannot automatically prove industry-wide laws (see [[kernel/07 Sources and Accuracy/03 Official and Cross-source Verification|07/03]]).

The canonical definitions of the seven evidence roles are in [[kernel/06 Knowledge Intake and Evolution/03 Source-to-Knowledge Pipeline|06/03]] Stage 4.
