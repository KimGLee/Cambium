...
- All images are first verified for path, format, dimensions, and references; when adding or modifying a diagram, image, or embed, run Level 0 / Level 1 per [[kernel/12 Quality Assurance/02 Rendering Verification#Rendering Verification Levels|Rendering Verification Levels]].
