...
This page is the stable entry for the Quality Assurance standard. Detailed rules are maintained by the responsibility-specific modules below.
...
| [[kernel/K12 Quality Assurance/07 Audit Evidence Reuse and Invalidation\|Audit Evidence Reuse and Invalidation]] and [`audit-dimension-base.yaml`](<K12 Quality Assurance/audit-dimension-base.yaml>) | `Purpose`, `Audit Layers`, `Dimension-specific Audit Evidence`, `Reuse Gate`, `Invalidation`, `Specialized Audit Boundary`, `Receipt Sealing and the Cold Chain`, `Terminal Reconciliation Rules`, `Related`; the YAML is the sole machine registry for base receipt dimensions, evidence roles, and Profile extension-target mappings |
