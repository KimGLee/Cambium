...
| expression artifacts registered by the `Expression Layer Entry` | the mapping, migration, and coverage dimensions registered in the `Audit Dimension Registry` |
