...
source_hash: '18910f9a1bad'
reviewed_source_hash: '18910f9a1bad'
reviewed_card_hash: '6e98220b40af'
---
...
- Materialize the current AuditPlan, invoke the registered producer for every due obligation, and preserve each planned evidence kind; each native producer must satisfy its plan-bound acceptance contract. Create the batch-review wrapper only after the complete due-stage closure resolves.
