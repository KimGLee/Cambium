...
source_hash: '0b94fffb630f'
reviewed_source_hash: '0b94fffb630f'
reviewed_card_hash: '2c721346927c'
---
...
- Stop on stale inputs, a failed Gate, conflicting state, uncertain write outcome, or a recovery condition that has no proven next action.
