...
source_hash: 'ae940551e827'
reviewed_source_hash: 'ae940551e827'
...
Create or change one canonical page within an already confirmed scope and owner boundary.
...
- Stop on disputed ownership, an unresolved source conflict, or a required field or relation that cannot be determined safely.
- Escalate when the page would require a new rule, exception, or scope change.

## Read-back hook

Resolve the applicable `R02:semantic-condition` edge for terminology, evidence, relationship, propagation, diagram, code, mathematics, or rendering questions. The referenced canonical owner supplies the judgment standard.
