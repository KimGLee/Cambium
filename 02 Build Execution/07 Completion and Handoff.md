...
- Previous: [[Knowledge Base Standards/02 Build Execution/06 Existing Changes Migration and Resume|Existing Changes Migration and Resume]].
...
- `required_QA_passed`：Single Note、Module、Interview、Source Promotion 和 Rendering gates 按适用范围通过。
