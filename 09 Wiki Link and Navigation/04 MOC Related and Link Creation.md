...
- Previous: [[Knowledge Base Standards/09 Wiki Link and Navigation/03 Path Alias and Heading Links|Path Alias and Heading Links]].
- Next: [[Knowledge Base Standards/09 Wiki Link and Navigation/05 Verification and Anti-patterns|Verification and Anti-patterns]].
...
Coverage map 是 [[Knowledge Base Standards/02 Build Execution/03 Inventory and Coverage Reconciliation#Phase 1: Inventory|Coverage Ledger]] 的读者视图，不独立维护另一套完成状态。页面有 incoming link、Roadmap entry 或可解析 Wiki link，只能证明可导航，不能证明 authoring、interview 或 evidence 状态已经完成。
