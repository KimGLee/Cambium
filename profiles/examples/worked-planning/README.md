...
|---|---|---|---|
| `check_profile` | `1.6.0` | `python3 Tools/check_profile.py profiles/examples/worked-planning` | exit 0 |
| `check_corpus_plan` | `1.5.0` | `python3 Tools/check_corpus_plan.py . --profile profiles/examples/worked-planning/profile.md` | exit 0 |
| `check_residual_content` | `1.1.0` | `python3 Tools/check_residual_content.py . --scan-id worked-planning-case-residuals --config profiles/examples/worked-planning/scan-configs/residual-scan.yaml --time-limit 55` | exit 0 |
