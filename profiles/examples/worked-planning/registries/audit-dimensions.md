...
Every judgment item below files under one of the seven base receipt dimensions. This profile registers no extension dimension: it has no artifact class whose fitness is judged independently of those seven.
