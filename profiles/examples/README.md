...
Between them the examples now show both sides of every optional and conditional switch in `profiles/_template/`: Atlas configures fourteen of the fifteen, Minimal Notes leaves all fifteen inactive, and each package states the reason for its own choice.
