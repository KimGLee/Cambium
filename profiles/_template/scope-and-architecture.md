...
| `Cross-domain Concepts Layer` | Layer ID | TODO(profile) |
| `Expression Layer Predicate` | Predicate | TODO(profile) |
| `Case Study Layer` | Layer ID | TODO(profile) |
| `Source Note Layer` | Layer ID | TODO(profile) |
| `Research Synthesis Layer` | Layer ID | TODO(profile) |
