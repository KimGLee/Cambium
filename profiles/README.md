...
A logical layer with multiple directories uses a semicolon-delimited list. Profile Scope is the sole owner of Layer IDs, directory sets, and layer responsibilities; the Global Map references those IDs instead of asking the adopter to repeat the same declarations.
